...
{
    internal static ITypeSymbol? GetCollectionTypeOrDefault(this ITypeSymbol typeSymbol)
    {
    ...
    private static ITypeSymbol? GetEnumeratorTypeOrDefault(this ITypeSymbol typeSymbol)
    {
        ...
        static bool IsGenericEnumerator(INamedTypeSymbol symbol)
            =>
            symbol.IsType("System.Collections.Generic", "IEnumerator") && symbol.TypeArguments.Length is 1;
